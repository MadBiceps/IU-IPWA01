...
import { faCircleCheck, faLocationDot, faPlus, faTrash, faTruckRampBox, faTshirt } from '@fortawesome/free-solid-svg-icons';
...
export class AppModule {
  constructor(library: FaIconLibrary) {
    library.addIcons(faTshirt, faPlus, faLocationDot, faTruckRampBox, faTrash, faCircleCheck);
  }
}
